...
Version  : 2.28.11.8
Release  : 52
URL      : https://files.pythonhosted.org/packages/e0/7d/09d353a2743d72fd287eee657144a9ac80b84e0f99c0dca2b6fc2c454e89/types-requests-2.28.11.8.tar.gz
Source0  : https://files.pythonhosted.org/packages/e0/7d/09d353a2743d72fd287eee657144a9ac80b84e0f99c0dca2b6fc2c454e89/types-requests-2.28.11.8.tar.gz
...
%prep
%setup -q -n types-requests-2.28.11.8
cd %{_builddir}/types-requests-2.28.11.8
pushd ..
cp -a types-requests-2.28.11.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674057099
