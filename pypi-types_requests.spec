...
Version  : 2.27.31
Release  : 26
URL      : https://files.pythonhosted.org/packages/14/d3/f009dc52ff7bc7296c4e47a7c886ee8cc7f2f438b9f49fe52a2661f42f3d/types-requests-2.27.31.tar.gz
Source0  : https://files.pythonhosted.org/packages/14/d3/f009dc52ff7bc7296c4e47a7c886ee8cc7f2f438b9f49fe52a2661f42f3d/types-requests-2.27.31.tar.gz
...
%prep
%setup -q -n types-requests-2.27.31
cd %{_builddir}/types-requests-2.27.31
pushd ..
cp -a types-requests-2.27.31 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655857695
