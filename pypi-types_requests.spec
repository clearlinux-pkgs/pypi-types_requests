...
Source0  : https://files.pythonhosted.org/packages/0f/c8/3a78030054f2e851489ea910c5165e06f96ba2c12002082f355860c9c9ab/types-requests-2.28.3.tar.gz
...
%prep
%setup -q -n types-requests-2.28.3
cd %{_builddir}/types-requests-2.28.3
pushd ..
cp -a types-requests-2.28.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658415646
