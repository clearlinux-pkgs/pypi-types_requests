...
Source0  : https://files.pythonhosted.org/packages/cf/99/ab96b7a68b26bbcff2865d0aa71bf6a895f04397a303dc027f96c58c4a58/types-requests-2.32.0.20240622.tar.gz
...
%prep
%setup -q -n types-requests-2.32.0.20240622
cd %{_builddir}/types-requests-2.32.0.20240622
pushd ..
cp -a types-requests-2.32.0.20240622 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720049173
