...
Version  : 2.27.28
Release  : 23
URL      : https://files.pythonhosted.org/packages/a4/bd/59b727fdc2c1f3a43cfdcdf41c34862cf9516e2762614285281d3a6da204/types-requests-2.27.28.tar.gz
Source0  : https://files.pythonhosted.org/packages/a4/bd/59b727fdc2c1f3a43cfdcdf41c34862cf9516e2762614285281d3a6da204/types-requests-2.27.28.tar.gz
...
%prep
%setup -q -n types-requests-2.27.28
cd %{_builddir}/types-requests-2.27.28
pushd ..
cp -a types-requests-2.27.28 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653582798
