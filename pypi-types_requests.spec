...
Source0  : https://files.pythonhosted.org/packages/8d/db/ad7df75037a21110deb624dae27b4868e881488f9e5411029a87536c0385/types-requests-2.27.30.tar.gz
...
%prep
%setup -q -n types-requests-2.27.30
cd %{_builddir}/types-requests-2.27.30
pushd ..
cp -a types-requests-2.27.30 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654186863
