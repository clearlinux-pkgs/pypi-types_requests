...
Version  : 2.28.8
Release  : 35
URL      : https://files.pythonhosted.org/packages/1b/b3/634a70f7fec28b239b18e42ebd54a4c8a62c2227a71555fe066e8f9d3a85/types-requests-2.28.8.tar.gz
Source0  : https://files.pythonhosted.org/packages/1b/b3/634a70f7fec28b239b18e42ebd54a4c8a62c2227a71555fe066e8f9d3a85/types-requests-2.28.8.tar.gz
...
%prep
%setup -q -n types-requests-2.28.8
cd %{_builddir}/types-requests-2.28.8
pushd ..
cp -a types-requests-2.28.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659712623
