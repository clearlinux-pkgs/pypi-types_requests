...
Version  : 2.28.11.2
Release  : 44
URL      : https://files.pythonhosted.org/packages/bb/0e/c84a67c6efc26b74344bdd8bb6e05932e0509745fb8e5e0ee0c80f39cf55/types-requests-2.28.11.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/bb/0e/c84a67c6efc26b74344bdd8bb6e05932e0509745fb8e5e0ee0c80f39cf55/types-requests-2.28.11.2.tar.gz
...
%prep
%setup -q -n types-requests-2.28.11.2
cd %{_builddir}/types-requests-2.28.11.2
pushd ..
cp -a types-requests-2.28.11.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665153693
