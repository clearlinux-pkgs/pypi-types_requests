...
Version  : 2.27.13
Release  : 9
URL      : https://files.pythonhosted.org/packages/7d/14/e8eafd72ddc6a418259f53de8cf35a77619ad72ea8f7e5529de854384a13/types-requests-2.27.13.tar.gz
Source0  : https://files.pythonhosted.org/packages/7d/14/e8eafd72ddc6a418259f53de8cf35a77619ad72ea8f7e5529de854384a13/types-requests-2.27.13.tar.gz
...
%prep
%setup -q -n types-requests-2.27.13
cd %{_builddir}/types-requests-2.27.13
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647529267
