...
Version  : 2.27.29
Release  : 24
URL      : https://files.pythonhosted.org/packages/44/41/c9a79ae08db096ebfe30835fa58da33c923d1085e0d27f1130b9166d41a1/types-requests-2.27.29.tar.gz
Source0  : https://files.pythonhosted.org/packages/44/41/c9a79ae08db096ebfe30835fa58da33c923d1085e0d27f1130b9166d41a1/types-requests-2.27.29.tar.gz
...
%prep
%setup -q -n types-requests-2.27.29
cd %{_builddir}/types-requests-2.27.29
pushd ..
cp -a types-requests-2.27.29 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653612005
