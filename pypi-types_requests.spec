...
Version  : 2.28.11.1
Release  : 42
URL      : https://files.pythonhosted.org/packages/1e/07/d6cc78e94f91846ce0c7254f7621a89c392224e98b51d039b2f1166b22a9/types-requests-2.28.11.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/1e/07/d6cc78e94f91846ce0c7254f7621a89c392224e98b51d039b2f1166b22a9/types-requests-2.28.11.1.tar.gz
...
%prep
%setup -q -n types-requests-2.28.11.1
cd %{_builddir}/types-requests-2.28.11.1
pushd ..
cp -a types-requests-2.28.11.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664888895
