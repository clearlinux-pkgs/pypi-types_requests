...
Version  : 2.28.11.3
Release  : 46
URL      : https://files.pythonhosted.org/packages/75/70/1683dfc6997636c5d590e36242c3842e14b671af0d68b9054eedd5bc2cd1/types-requests-2.28.11.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/75/70/1683dfc6997636c5d590e36242c3842e14b671af0d68b9054eedd5bc2cd1/types-requests-2.28.11.3.tar.gz
...
%prep
%setup -q -n types-requests-2.28.11.3
cd %{_builddir}/types-requests-2.28.11.3
pushd ..
cp -a types-requests-2.28.11.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667958640
