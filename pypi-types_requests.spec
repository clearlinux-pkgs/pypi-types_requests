...
Version  : 2.27.9
Release  : 5
URL      : https://files.pythonhosted.org/packages/6b/87/1fb2383d1b90e4175716fbd4c23fe9579fbaacf36ca64391ecdc13b21db9/types-requests-2.27.9.tar.gz
Source0  : https://files.pythonhosted.org/packages/6b/87/1fb2383d1b90e4175716fbd4c23fe9579fbaacf36ca64391ecdc13b21db9/types-requests-2.27.9.tar.gz
...
%prep
%setup -q -n types-requests-2.27.9
cd %{_builddir}/types-requests-2.27.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644515071
