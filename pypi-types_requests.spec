...
Source0  : https://files.pythonhosted.org/packages/00/7d/eb174f74e3f5634eaacb38031bbe467dfe2e545bc255e5c90096ec46bc46/types_requests-2.32.0.20250328.tar.gz
Summary  : Typing stubs for requests
Group    : Development/Tools
License  : Apache-2.0
Requires: pypi-types_requests-license = %{version}-%{release}
...
%description license
license components for the pypi-types_requests package.
...
%prep
%setup -q -n types_requests-2.32.0.20250328
cd %{_builddir}/types_requests-2.32.0.20250328
pushd ..
cp -a types_requests-2.32.0.20250328 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743179155
...
export MAKEFLAGS=%{?_smp_mflags}
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/pypi-types_requests
cp %{_builddir}/types_requests-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-types_requests/dff786a9b9a95ffbea8a758f43143c45bc64cd66 || :
...
/usr/share/package-licenses/pypi-types_requests/dff786a9b9a95ffbea8a758f43143c45bc64cd66
