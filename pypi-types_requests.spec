...
Source0  : https://files.pythonhosted.org/packages/f0/16/b5df624c99f856b1671de918afa4737af3e5e623652fdf2a5b95aa3130fa/types-requests-2.28.2.tar.gz
...
%prep
%setup -q -n types-requests-2.28.2
cd %{_builddir}/types-requests-2.28.2
pushd ..
cp -a types-requests-2.28.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658186457
