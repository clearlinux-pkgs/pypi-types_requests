...
Source0  : https://files.pythonhosted.org/packages/06/c1/cdc4f9b8cfd9130fbe6276db574f114541f4231fcc6fb29648289e6e3390/types_requests-2.32.0.20250515.tar.gz
...
%prep
%setup -q -n types_requests-2.32.0.20250515
cd %{_builddir}/types_requests-2.32.0.20250515
pushd ..
cp -a types_requests-2.32.0.20250515 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747319636
