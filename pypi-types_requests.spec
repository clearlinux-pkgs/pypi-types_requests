...
Version  : 2.28.5
Release  : 32
URL      : https://files.pythonhosted.org/packages/b4/b0/f43b6c00c7b3d586419816ff8b9ee7bfce8ad9ec16e3b372c3562265476e/types-requests-2.28.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/b4/b0/f43b6c00c7b3d586419816ff8b9ee7bfce8ad9ec16e3b372c3562265476e/types-requests-2.28.5.tar.gz
...
%prep
%setup -q -n types-requests-2.28.5
cd %{_builddir}/types-requests-2.28.5
pushd ..
cp -a types-requests-2.28.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658942866
