...
Source0  : https://files.pythonhosted.org/packages/57/12/b58964f89f921b2e8a2841b21ffac2e95ba4c2ed7c9323eeb843a8dab638/types-requests-2.28.11.4.tar.gz
...
%prep
%setup -q -n types-requests-2.28.11.4
cd %{_builddir}/types-requests-2.28.11.4
pushd ..
cp -a types-requests-2.28.11.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668010791
