...
Version  : 2.28.11.9
Release  : 53
URL      : https://files.pythonhosted.org/packages/33/48/afd692533deee611a4f05048e706469dfff65054dc581539bd8d1e17f054/types-requests-2.28.11.9.tar.gz
Source0  : https://files.pythonhosted.org/packages/33/48/afd692533deee611a4f05048e706469dfff65054dc581539bd8d1e17f054/types-requests-2.28.11.9.tar.gz
...
%prep
%setup -q -n types-requests-2.28.11.9
cd %{_builddir}/types-requests-2.28.11.9
pushd ..
cp -a types-requests-2.28.11.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675734708
