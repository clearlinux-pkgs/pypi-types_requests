...
Source0  : https://files.pythonhosted.org/packages/19/1f/42dbf39ff88c67c71485e27485b1c3965ad882dc3b76c256f2d45401ffa8/types-requests-2.27.27.tar.gz
...
%prep
%setup -q -n types-requests-2.27.27
cd %{_builddir}/types-requests-2.27.27
pushd ..
cp -a types-requests-2.27.27 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653009055
