...
Version  : 2.28.11.14
Release  : 56
URL      : https://files.pythonhosted.org/packages/0e/84/127b3d06ebb9f71ac8bda9edf8852f3b507951a5000c7789896a70838fff/types-requests-2.28.11.14.tar.gz
Source0  : https://files.pythonhosted.org/packages/0e/84/127b3d06ebb9f71ac8bda9edf8852f3b507951a5000c7789896a70838fff/types-requests-2.28.11.14.tar.gz
...
%prep
%setup -q -n types-requests-2.28.11.14
cd %{_builddir}/types-requests-2.28.11.14
pushd ..
cp -a types-requests-2.28.11.14 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676998589
