...
Source0  : https://files.pythonhosted.org/packages/e5/9a/c11348b69e80858799e943106e414a6780ebb98e87eaa1cd8ebe61d09579/types-requests-2.28.0.tar.gz
...
%prep
%setup -q -n types-requests-2.28.0
cd %{_builddir}/types-requests-2.28.0
pushd ..
cp -a types-requests-2.28.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656344353
