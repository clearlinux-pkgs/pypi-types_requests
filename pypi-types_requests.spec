...
Version  : 2.28.11
Release  : 41
URL      : https://files.pythonhosted.org/packages/85/10/378bd8c64506ac46638d1b7fb63189ef68ec7961f7c7056d40bddcd448fe/types-requests-2.28.11.tar.gz
Source0  : https://files.pythonhosted.org/packages/85/10/378bd8c64506ac46638d1b7fb63189ef68ec7961f7c7056d40bddcd448fe/types-requests-2.28.11.tar.gz
...
%prep
%setup -q -n types-requests-2.28.11
cd %{_builddir}/types-requests-2.28.11
pushd ..
cp -a types-requests-2.28.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663862837
