...
Version  : 2.28.7
Release  : 34
URL      : https://files.pythonhosted.org/packages/d0/3a/c0b695df523073e7635eba23ba34e44c9a0e49980cecd2b1cdbbef1705a8/types-requests-2.28.7.tar.gz
Source0  : https://files.pythonhosted.org/packages/d0/3a/c0b695df523073e7635eba23ba34e44c9a0e49980cecd2b1cdbbef1705a8/types-requests-2.28.7.tar.gz
...
%prep
%setup -q -n types-requests-2.28.7
cd %{_builddir}/types-requests-2.28.7
pushd ..
cp -a types-requests-2.28.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659452812
