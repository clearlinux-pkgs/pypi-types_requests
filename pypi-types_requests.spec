...
Source0  : https://files.pythonhosted.org/packages/05/7d/87a523c17e941626a3eebf397a3ce669c258ff31b1b992f5b11c365ee25f/types-requests-2.28.9.tar.gz
...
%prep
%setup -q -n types-requests-2.28.9
cd %{_builddir}/types-requests-2.28.9
pushd ..
cp -a types-requests-2.28.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661194127
