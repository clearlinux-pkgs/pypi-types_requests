...
Version  : 2.28.4
Release  : 31
URL      : https://files.pythonhosted.org/packages/d4/93/473cdfc4d9ba4b2696d441d88b602765618fb22f7c5a5b97e1ff69548a38/types-requests-2.28.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/d4/93/473cdfc4d9ba4b2696d441d88b602765618fb22f7c5a5b97e1ff69548a38/types-requests-2.28.4.tar.gz
...
%prep
%setup -q -n types-requests-2.28.4
cd %{_builddir}/types-requests-2.28.4
pushd ..
cp -a types-requests-2.28.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658842041
