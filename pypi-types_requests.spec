...
Source0  : https://files.pythonhosted.org/packages/68/09/4241bef81461b4a283e723ca39f580ff4a0cfbec434a4b07570822d14cc8/types-requests-2.28.6.tar.gz
...
%prep
%setup -q -n types-requests-2.28.6
cd %{_builddir}/types-requests-2.28.6
pushd ..
cp -a types-requests-2.28.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659368759
